...
def segment_ROI(
    ...
    Args:
        ...
        channels: Which channels to use. If only one channel is provided, [0,
            ...
            dimension of x has lenth of 2), [[1, 2]] should be used (x[0, :, :,
            :] contains the membrane channel first & x[1, :, :, :] the nuclear
            channel).
        ...
        net_avg: Whether to use cellpose net averaging to run the 4 built-in
            networks (useful for nuclei, cyto & cyto2, not sure it works for
            the others)
...
def cellpose_segmentation(
    *,
    ...
    Args:
        ...
        level: Pyramid level of the image to be segmented. Choose 0 to process
            at full resolution.
        ...
        input_ROI_table: Name of the ROI table over which the task loops to
            apply Cellpose segmentation. Example: "FOV_ROI_table" => loop over
            the field of views "organoid_ROI_table" => loop over the organoid
            ROI table generated by another task "well_ROI_table" => process the
        ...
        output_label_name: Name of the output label image (e.g.
            ``"organoids"``).
        ...
        min_size: Parameter of ``CellposeModel`` class. Minimum size of the
            segmented objects (in pixels). Use -1 to turn off the size filter.
        ...
        net_avg: Parameter of ``CellposeModel`` class. Whether to use cellpose
            ...
            cyto & cyto2, not sure it works for the others).
