    ...
    *,
    ...
    Args:
        ...
        metadata: dictionary containing metadata about the OME-Zarr.
            ...
            This determines how many pyramid levels are built for the
            segmentation. "coarsening_xy": int, coarsening factor in XY of the
            downsampling when building the pyramid. "plate": List of plates.
            Example: ["MyPlate.zarr"] "well": List of wells in the OME-Zarr
